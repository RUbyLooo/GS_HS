...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    elif policy_type == "actvla":
        return ACTvlaConfig(**kwargs)
    elif policy_type == "vggtvla":
        return VGGTVLAConifg(**kwargs)
    elif policy_type == "qwenvla":
        return QwenVLAConfig(**kwargs)
    elif policy_type == "egola":
        return EgoVLAConfig(**kwargs)
    else:
